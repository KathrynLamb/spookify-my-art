...
//   const missing =
//     !fileUrl || !imageId || !amount || !currency || !size || !orientation; // ⬅️ removed frameColor
...
//       createOrder: async () => {
//         const payload: any = { amount, currency, title, imageId, fileUrl, size, orientation };
//         if (frameColor)  payload.frameColor  = frameColor;
//         if (productUid)  payload.productUid  = productUid; // if your backend/Gelato uses it
