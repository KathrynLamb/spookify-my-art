...
//       }
//     },
//     [handleUpload, references, originalUrl, plan, sendMessage, addReference, projectId, updateProject]
//   );
//   /* -------------------------------------------------------------
...
// const cleanMessage = useCallback((raw: ChatMessage) => {
//   return {
...
//     }
//   },
//   [user, productId, imageId, cleanMessage]
// );
...
// // -------------------------------------------------------------
// const updateProject = useCallback(async (changes: Record<string, unknown>) => {
//   if (!projectId) return;
...
//   }
// }, [previewUrl, projectId, updateProject]);
